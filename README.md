...
## 📌 Тестовое задание в 1С Предприятие 8.3

### Описание:
Пример блока с добавлением пиццы и автоматизации подсчета суммы при заказе.

🔗 [Выполненное задание в презентации](https://github.com/dinkana/bus_analyst/blob/main/1%D1%81.pdf)

🔗 [Выполненное задание для 1С](https://github.com/dinkana/bus_analyst/blob/main/1Cv8.dt)
